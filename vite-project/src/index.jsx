...
//const canvasRef = React.useRef(); // Membuat ref untuk canvas

//import Experience from './Experience.jsx'
import { KeyboardControls } from '@react-three/drei'
//import Interface from './Interface.jsx'

const cameraPosition = [0.426, 0.677, -2.095];
const cameraRotation = [2.828, 0.191, 3.108];
      ...
      <Canvas>
        ...
        <ambientLight />
         ...
         <canvas ref={canvasRef} />
            ...
            <directionalLight position={[1, 1, 1]} intensity={1} /> {/* Contoh penggunaan pencahayaan */}
